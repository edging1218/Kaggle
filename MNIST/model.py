...
class Model:
    def __init__(self, data, model_type, model_param):
        self.data = data
    ...
    def run_all(self, pred_prob=False, params=True):
        return self.run(self.data.train,
                        self.data.train_target,
                        self.data.test,
                        pred_prob,
                        params)
    ...
    def cross_validation_all(self, k_fold, metrics, pred_prob=False, params=True):
        return self.cross_validation(self.data.train,
                                     self.data.train_target,
                                     k_fold,
                                     metrics,
                                     pred_prob,
    ...
    def grid_search_all(self, metrics, k_fold):
        return self.grid_search(self.data.train,
                                self.data.train_target,
                                self.data.test,
                                metrics,
                                k_fold,
